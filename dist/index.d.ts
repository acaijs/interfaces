...
declare type MiddlewareResponse = any | ResponseInterface | string | Record<string, unknown>;
declare type nextWrap = (request: ServerRequest) => MiddlewareResponse | Promise<MiddlewareResponse>;
declare type MiddlewareCbType = (request: ServerRequest, next: nextWrap, params: string[]) => MiddlewareResponse | Promise<MiddlewareResponse>;
declare type MiddlewareClassType = {
    onApply: MiddlewareCbType;
};
declare type MiddlewareType = MiddlewareCbType | MiddlewareClassType;
...
interface SerializedAdapterInterface {
    ...
    middlewares: Record<string, MiddlewareType>;
    globals: MiddlewareType[];
    running: boolean;
}
...
declare type ClassType<Instance extends Record<string, any>> = {
    new (): Instance;
};

export { AdapterInterface, ClassType, CustomExceptionInterface, MiddlewareCbType, MiddlewareClassType, MiddlewareType, ProviderInterface, ResponseInterface, SerializedAdapterInterface, ServerConfigInterface, ServerInterface, ServerRequest };
